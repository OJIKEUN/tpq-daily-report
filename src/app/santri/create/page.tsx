    ...
    <div className="flex-1 flex flex-col min-h-screen bg-base-200">
      ...
      <div className="navbar bg-base-100 shadow-sm sticky top-0 z-40 border-b border-base-200">
        ...
        <div className="flex-1">
          <h1 className="text-lg font-bold">Tambah Santri Baru</h1>
        </div>
      </div>
      ...
      <main className="flex-1 px-5 py-6 animate-fade-in pb-16">
        <div className="card bg-base-100 shadow-xl border border-base-200/60">
          <div className="card-body p-5">
            <div className="mb-4">
              <h2 className="font-bold text-base-content text-base">Formulir Data Santri</h2>
              <p className="text-xs text-base-content/60 mt-0.5">
                Lengkapi identitas santriwan atau santriwati baru di bawah ini.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              >
                {isSubmitting ? (
                  ...
                  <>
                    <Send size={18} /> Simpan Data Santri
                  </>
                )}
              </button>
            </form>
